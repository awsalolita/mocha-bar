...
class Project(Base):
    ...
    # Back-reference: every client that points at this project.
    clients: Mapped[list["Client"]] = relationship(back_populates="project")
...
class Client(Base):
    ...
    def to_dict(self):
        return {"id": self.id, "name": self.name, "project_id": self.project_id}
